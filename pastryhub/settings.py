"""
Django settings for pastryhub project.
...
WSGI_APPLICATION = 'pastryhub.wsgi.application'
...
# Disable automatic trailing slash appending to URLs
APPEND_SLASH = False
